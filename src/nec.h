...
#define TIME_START_HALFBIT_HIGH_REPEAT_MIN				((TIME_START_HALFBIT_HIGH_COMMAND - TIME_TOLLERANCE) / SAMPLE_RATIO)
#define TIME_START_HALFBIT_HIGH_REPEAT_MAX				((TIME_START_HALFBIT_HIGH_COMMAND + TIME_TOLLERANCE) / SAMPLE_RATIO)
